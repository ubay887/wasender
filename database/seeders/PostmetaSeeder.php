...
class PostmetaSeeder extends Seeder
{
    ...
    public function run()
    {
        $postmetas = [
            ...
            ['id' => '2', 'post_id' => '2', 'key' => 'excerpt', 'value' => 'No, you only need a email to sign up.'],
            ['id' => '3', 'post_id' => '3', 'key' => 'excerpt', 'value' => 'Yes, If you are unhappy with our service, we offer 30 days money-back guarantee on any plan.'],
            ['id' => '4', 'post_id' => '4', 'key' => 'excerpt', 'value' => '{"facebook":"https:\\/\\/www.facebook.com\\/","twitter":"https:\\/\\/twitter.com\\/","linkedin":"https:\\/\\/linkedin.com\\/","instagram":"https:\\/\\/www.instagram.com\\/"}'],
            ['id' => '5', 'post_id' => '4', 'key' => 'description', 'value' => 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.'],
            ['id' => '6', 'post_id' => '4', 'key' => 'preview', 'value' => '/uploads/23/03/1678125197LZ4zAxvVjarz0PrmZCqK.png'],
            ['id' => '7', 'post_id' => '5', 'key' => 'excerpt', 'value' => '{"facebook":"https:\\/\\/www.facebook.com\\/","twitter":"https:\\/\\/twitter.com\\/","linkedin":"https:\\/\\/linkedin.com\\/","instagram":"https:\\/\\/www.instagram.com\\/"}'],
            ['id' => '8', 'post_id' => '5', 'key' => 'description', 'value' => 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.'],
            ['id' => '9', 'post_id' => '5', 'key' => 'preview', 'value' => '/uploads/23/03/1678125246G7FoUHHxe2C88n1cVXCq.png'],
            ['id' => '10', 'post_id' => '6', 'key' => 'excerpt', 'value' => '{"facebook":"https:\\/\\/www.facebook.com\\/","twitter":"https:\\/\\/twitter.com\\/","linkedin":"https:\\/\\/linkedin.com\\/","instagram":"https:\\/\\/www.instagram.com\\/"}'],
            ['id' => '11', 'post_id' => '6', 'key' => 'description', 'value' => 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.'],
            ['id' => '12', 'post_id' => '6', 'key' => 'preview', 'value' => '/uploads/23/03/16781252849ApdWcy0jUhLRb9QtCL4.png'],
            ['id' => '13', 'post_id' => '7', 'key' => 'excerpt', 'value' => '{"facebook":"https:\\/\\/www.facebook.com\\/","twitter":"https:\\/\\/twitter.com\\/","linkedin":"https:\\/\\/linkedin.com\\/","instagram":"https:\\/\\/www.instagram.com\\/"}'],
            ['id' => '14', 'post_id' => '7', 'key' => 'description', 'value' => 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.'],
            ['id' => '15', 'post_id' => '7', 'key' => 'preview', 'value' => '/uploads/23/03/1678125323UINo4L0ZND1ErxlWCAFu.png'],
            ['id' => '16', 'post_id' => '8', 'key' => 'preview', 'value' => '/uploads/23/03/1678128734p2mgTWEhEKwm5MsxhunY.png'],
            ['id' => '17', 'post_id' => '8', 'key' => 'short_description', 'value' => 'In a world that’s increasingly getting commoditized, thanks to technology, it’s an open secret that customer focus is the real differentiator. This Gospel truth is germane to every business function, but in marketing it’s indispensable. Reason being the constantly changing needs, wants and desires of customers. New age marketing therefore, is all about unique individual experiences through tools that bring brands closer to their customer.'],
            ['id' => '18', 'post_id' => '8', 'key' => 'main_description', 'value' => 'Today there’s literally an ocean when it comes to the number of available tools for marketers but none comes close to the effectiveness of QBM. Quality Based Messaging or QBM is a feature under WhatsApp business API which helps businesses engage customers through contextual messaging. These messages need to meet the quality criteria defined by WhatsApp and hence the name- Quality Based Messaging.'],
            ['id' => '19', 'post_id' => '8', 'key' => 'seo', 'value' => '{"title":"Boost your business growth with WhatsApp Quality Based Messaging","description":"In a world that\\u2019s increasingly getting commoditized, thanks to technology, it\\u2019s an open secret that customer focus is the real differentiator. This Gospel truth is germane to every business function, but in marketing it\\u2019s indispensable. Reason being the constantly changing needs, wants and desires of customers. New age marketing therefore, is all about unique individual experiences through tools that bring brands closer to their customer.","tags":"wa, whatsapp, devstation, qserve, whatsserve, whatserder"}'],
            ['id' => '20', 'post_id' => '9', 'key' => 'preview', 'value' => '/uploads/23/03/1678129064eIpoGudjOtETN0JhQRzG.png'],
            ['id' => '21', 'post_id' => '9', 'key' => 'short_description', 'value' => 'In the competitive business landscape, if there’s one thing that has led to the massive growth of internet businesses, it is digital advertising. The $600 billion industry holds an outsized control on customers—- who buys what and thus to the fortunes of these businesses. An interesting aspect of digital advertising is its dynamic and ever-evolving nature, from search ads to video and voice search with the latest being Click to Chat ads. Click to Chat ads, although at a nascent stage currently,'],
            ['id' => '22', 'post_id' => '9', 'key' => 'main_description', 'value' => 'In Feynman speak, Click to Chat ads are ads that are conversational in nature. With precise targeting, marketers are finding it to be much more effective in addressing the shortcomings of typical digital ads.
        ...
        In summary, while ChatGPT can provide conversational capabilities for certain use cases, it is not designed to replace enterprise conversational AI platforms, which offer greater customization, security, integration, support, maintenance, and scalability capabilities to meet the needs of large businesses.'],
            ['id' => '27', 'post_id' => '10', 'key' => 'seo', 'value' => '{"title":"Why ChatGPT Cannot Replace Conversational AI Platforms?","description":"ChatGPT (Conversational Generative Pre-trained Transformer) is a newly released open-source conversational AI platform. It has been praised for its ability to generate natural language responses to user inputs, and many have hailed it as the next step in creating more human-like conversations. However, despite its promise, certain limitations still prevent it from being a viable replacement for other conversational AI platforms. Let\\u2019s explore these limitations and how they can be addressed.","tags":"wa, whatsapp, devstation, qserve, whatsserve","image":"\\/uploads\\/23\\/03\\/16781292529yMlP8qfUEaRjJic39bs.png"}'],
            ['id' => '30', 'post_id' => '12', 'key' => 'excerpt', 'value' => 'Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old.'],
            ['id' => '31', 'post_id' => '12', 'key' => 'preview', 'value' => '/uploads/23/03/1678130604XsBOBA2JdT4D3dUMsVPO.jpg'],
            ['id' => '32', 'post_id' => '13', 'key' => 'excerpt', 'value' => 'It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum'],
            ['id' => '33', 'post_id' => '13', 'key' => 'preview', 'value' => '/uploads/23/03/1678130652BHfP85klZ25vaXpBU6AT.jpg'],
            ['id' => '34', 'post_id' => '14', 'key' => 'excerpt', 'value' => 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s'],
            ['id' => '35', 'post_id' => '14', 'key' => 'preview', 'value' => '/uploads/23/03/1678130699E0RrnxKNI6tkb6Qc1eV1.jpg'],
            ['id' => '36', 'post_id' => '15', 'key' => 'excerpt', 'value' => 'Boost digital finance adoption with instant balance inquiries, portfolio recommendations, hassle-free claims settlement, cross-sell and more'],
            ['id' => '37', 'post_id' => '16', 'key' => 'excerpt', 'value' => 'Revolutionize your restaurant operations with WhatsApp-based ordering, meal and add-on recommendations, payments and real-time delivery updates'],
            ['id' => '38', 'post_id' => '17', 'key' => 'excerpt', 'value' => 'Create multistage campaigns in just a few clicks and plan your campaigns ahead of time with pre-built templates'],
        ...
        This increases customer satisfaction and gives your business an upper hand against competitors. WhatsApp auto replies make life much easier for all growing businesses.'],
            ['id' => '48', 'post_id' => '19', 'key' => 'preview', 'value' => '/uploads/23/03/1678145544w3aon4jCrAciwsSaTXCo.png'],
            ['id' => '49', 'post_id' => '19', 'key' => 'banner', 'value' => '/uploads/23/03/1678178152NI8xZNWqa96WzC13Aytg.gif'],
            ['id' => '50', 'post_id' => '20', 'key' => 'excerpt', 'value' => 'WhatsApp users can schedule posts on the app to plan and send text, photos or videos. The posts can be scheduled for WhatsApp business or to send wishes on birthdays and festivals.'],
            ['id' => '51', 'post_id' => '20', 'key' => 'main_description', 'value' => 'With 2 billion+ active users, WhatsApp is the most widely used communication app. WhatsApp allows you to share text messages, multi-media, location & now money. With all these useful features, you may want to schedule a WhatsApp message for wishing someone their birthday or remind your friends about some events. Or if you’re a business, you may want to schedule payment reminders on the last day of subscriptions or cart reminders to your customers’ WhatsApp. Or, your business needs to automate WhatsApp Business greeting messages to all new customers/subscribers.'],
            ['id' => '52', 'post_id' => '20', 'key' => 'preview', 'value' => '/uploads/23/03/1678176166I16bhCDLteYzyEXmiydB.png'],
            ['id' => '53', 'post_id' => '20', 'key' => 'banner', 'value' => '/uploads/23/03/16781761667IC0JxTR0A4nDQ3pPkPn.webp'],
            ['id' => '54', 'post_id' => '21', 'key' => 'excerpt', 'value' => 'WA Bulk messaging is the dissemination of large numbers of messages for delivery to WASender software. It is used by media companies, banks and other enterprises and consumer brands for a variety of purposes including entertainment, enterprise and mobile marketing.'],
            ['id' => '55', 'post_id' => '21', 'key' => 'main_description', 'value' => 'A bulk message is a message that is sent from a single WhatsApp Business user to multiple phone numbers at the same time. All receivers of the message will see it coming in as a private message. WhatsApp bulk messaging first was a consumer-only feature, but it’s now also available for businesses. For businesses, this means they can now also use WhatsApp for outbound marketing activities.'],
            ['id' => '56', 'post_id' => '21', 'key' => 'preview', 'value' => '/uploads/23/03/167817697016QUKcDn2rlERcMDuR2p.png'],
            ['id' => '57', 'post_id' => '21', 'key' => 'banner', 'value' => '/uploads/23/03/1678177795QbOsO2mocgkgO8NRF071.png'],
            ['id' => '58', 'post_id' => '22', 'key' => 'excerpt', 'value' => 'Representational state transfer is a software architectural style that describes the architecture of the Web.'],
            ['id' => '59', 'post_id' => '22', 'key' => 'main_description', 'value' => 'An API is a set of definitions and protocols for building and integrating application software. It’s sometimes referred to as a contract between an information provider and an information user—establishing the content required from the consumer (the call) and the content required by the producer (the response). For example, the API design for a weather service could specify that the user supply a zip code and that the producer reply with a 2-part answer, the first being the high temperature, and the second being the low.'],
            ['id' => '60', 'post_id' => '22', 'key' => 'preview', 'value' => '/uploads/23/03/1678177358eT0wu71Go2ANWmiEVTrP.png'],
            ['id' => '61', 'post_id' => '22', 'key' => 'banner', 'value' => '/uploads/23/03/16781773587loKRma922J59f5EOXHQ.png'],
            ['id' => '62', 'post_id' => '23', 'key' => 'excerpt', 'value' => 'WASender is the best quaint james bond victoria sponge happy days cras.'],
            ['id' => '63', 'post_id' => '24', 'key' => 'excerpt', 'value' => 'No you can simply register with your email'],
            ['id' => '64', 'post_id' => '25', 'key' => 'excerpt', 'value' => 'WASender has supported free 10 days trial. You don\'t need to add credit card information.'],
            ['id' => '65', 'post_id' => '26', 'key' => 'description', 'value' => 'What is Lorem Ipsum?
...
It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using \'Content here, content here\', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for \'lorem ipsum\' will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).'],
            ['id' => '66', 'post_id' => '26', 'key' => 'seo', 'value' => '{"title":"terms and conditions","description":"orem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, w","tags":"wa, whatsapp, devstation, qserve, whatsserve"}'],
        ];
